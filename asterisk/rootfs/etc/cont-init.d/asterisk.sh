...
if ! bashio::fs.directory_exists '/media/asterisk'; then
    ...
    rsync -a -v --ignore-existing /var/lib/asterisk/moh/. /media/asterisk/moh/ || bashio::exit.nok 'Failed to make sample moh.'
    rsync -a -v --ignore-existing /var/lib/asterisk/sounds/. /media/asterisk/sounds/ || bashio::exit.nok 'Failed to make sample sounds.'    
fi

cp -a -f /media/asterisk/. /var/lib/asterisk/ || bashio::exit.nok 'Failed to get sounds from /media/asterisk/.'